...
async function default_1(args = {}) {
    ...
    try {
        ...
        if (!fileID) {
            figmaUrl = null;
            throw new Error(`Figma File ID was not parsed correctly. Input: ${figma.src}`);
        }
        console.log("\n", chalk_1.default.greenBright("info"), "Importing from ID", chalk_1.default.gray(fileID), "with access token", chalk_1.default.gray(figma.accessToken), "to", chalk_1.default.gray(path_1.default.resolve(figma.output)));
